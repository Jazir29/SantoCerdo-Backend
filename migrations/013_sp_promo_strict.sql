...
-- ============================================================
--  sp_order_create  (v2 — promoción inválida lanza error)
-- ============================================================
...
BEGIN
  ...
  -- Aplicar promoción (ahora lanza error si es inválida)
  IF p_promotion_id IS NOT NULL THEN
    ...
    IF done THEN
      SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Promoción inválida o expirada';
    END IF;
    IF v_promo_max IS NOT NULL AND v_promo_used >= v_promo_max THEN
      SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Esta promoción ha alcanzado su límite de usos';
    END IF;
...
-- ============================================================
--  sp_order_update  (v2 — promoción inválida lanza error)
-- ============================================================
